...
export class Puppeteer {
  ...
  private browserConfig = {
    ...
    executablePath: '/usr/bin/microsoft-edge' // Options: chromium, firefox, microsoft-edge, google-chrome
  };
  ...
  async getPage(browser: Browser, resolution: { width: number; height: number }): Promise<Page> {
  ...
  async configureGeolocation(browser: Browser, page: Page): Promise<void> {
    ...
    await context.overridePermissions('https://casino.sportingbet.bet.br/pt-br/livecasino?q=1', ['geolocation']);
